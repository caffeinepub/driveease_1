  ...
  if (statusScreen === "pending") {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <PageHeader subtitle="Captain Portal" />
          ...
          >
            ...
            {loginError && (
              <div
                ...
                data-ocid="captain_login.error_state"
              >
                <AlertCircle size={14} />
                {loginError}
              </div>
            ...
            <div className="space-y-4">
              ...
              {!otpSent ? (
                <button
                  ...
                  data-ocid="captain_login.submit_button"
                >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    data-ocid="captain_login.confirm_button"
                  >
                    Verify & Login ✓
                  </button>
                </div>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="max-w-2xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                data-ocid="captain_login.toggle"
              >
                <span
              ...
              <button
                ...
                data-ocid="captain_login.close_button"
              >
                <LogOut size={18} />
                <span>Logout</span>
              </button>
        ...
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
                ...
                >
                  ...
                  <div className="flex gap-2 mt-3">
                    ...
                    <button
                      ...
                      data-ocid="captain_login.delete_button"
                    >
                      <X size={14} /> Decline
                    </button>
                  </div>
          ...
          <div className="rounded-2xl p-5 bg-white border border-gray-200 shadow-sm">
            ...
            {withdrawError && (
              <p className="text-red-600" data-ocid="captain_login.error_state">
                {withdrawError}
              </p>
            )}
            {withdrawStatus && (
              <p
                ...
                data-ocid="captain_login.success_state"
              >
                {withdrawStatus}
              </p>
            )}
                    ...
                    {!rideStarted[b.id] ? (
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        ...
                        <button
                          ...
                          data-ocid="captain_login.primary_button"
                        >
                          🚗 Start Ride
                        </button>
                      </div>
